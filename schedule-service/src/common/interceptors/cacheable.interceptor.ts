...
/**
 * Interceptor that implements cache-aside for methods decorated with `@Cacheable`.
 *
 * - On call: checks cache, returns cached value if present.
 * - On miss: executes the method, stores result in cache.
 */
@Injectable()
